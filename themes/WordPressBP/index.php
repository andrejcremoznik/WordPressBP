		...
		<article <?php post_class() ?>>
			<header>
				...
				<p class="post-meta">
					...
					<span class="meta category"><?php _e('Category', 'WordPressBP') ?>:<?php the_category(', ') ?></span>
					<span class="meta tags"><?php the_tags(__('Tags', 'WordPressBP').': ',', ') ?></span>
					<span class="meta author"><?php _e('Author', 'WordPressBP')?>: <?php the_author_posts_link() ?></span>
				</p>
			</header>
			<?php the_excerpt() ?>
		</article>
